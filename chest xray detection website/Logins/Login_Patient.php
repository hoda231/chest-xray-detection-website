...
if ($stmt = $con->prepare('SELECT Patient_Name, Patient_Pass FROM patients WHERE Patient_Email = ?')) {
...
<html>
    <head>
        <meta charset="utf-8">
        <title>Login</title>
        <link rel="stylesheet" href="Login_Patient.css">
